...
<head>
    ...
    <link href="<?php echo URL_BASE ?>assets/assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="<?php echo URL_BASE ?>assets/assets/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URL_BASE ?>assets/assets/css/forms/switches.css">
</head>
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" action="<?php echo URL_BASE . "login/logar" ?>" method="POST">
                            <div class="form">
    ...
    <script src="<?php echo URL_BASE ?>assets/assets/js/authentication/form-2.js"></script>
